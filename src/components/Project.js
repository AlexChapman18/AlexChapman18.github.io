...
const Project = ({title, text, image, git, YouTube, tool1, tool2, tool3}) => {
  return (
    <div className="project-container">
      ...
      <div className='project-imageText'>
        <img className='project-imageText-image' src={image} alt="Image of project" />
        <div className='project-imageText-text'>
          <p className='section-text'>{text}</p>
          <ul className='project-toolList'>
